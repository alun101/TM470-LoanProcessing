...
module {:extern ""BankSystem""} BankSystem {
  ...
  export
    ...
    provides Bank.capitalFundValue, Bank.reservedFunds, Bank.loans, Bank.customers, Bank.customerLoans, Bank._ctor, Bank.newApplication, Bank.registerApplication, Bank.registerCustomer, Bank.registerLoan, Bank.associateCustomerLoan, Bank.processApplication, Bank.addLoan, Bank.addCustomer, Bank.informCustomer, Bank.obtainCustomerCreditScore, Bank.verifyCapitalAmount, Bank.reserveLoanFunds, Bank.completeApplication, Bank.releaseLoanFunds, Bank.transferLoanToCustomer, Bank.logEvent
  ...
  class Bank {
      ...
      decreases theCustomer, theLoan
    {
      ...
      if loanStatus == ""approved"" {
        ...
        var message: string := ""Your application has been successful. The required loan amount has been transferred to account number: "" + accNo + "" sort code: "" + sortCode;
...
module {:extern ""User""} User {
  ...
  export
    ...
    provides Customer.customerReference, Customer._ctor, Customer.getName, Customer.getAge, Customer.getPaymentDetails, Customer.getMonthlyIncome, Customer.getMonthlyOutgoings, Customer.getCustomerReference
    reveals Reference
...
namespace Product {
  ...
  public partial class Reference {
    ...
    public BigInteger getReferenceNumber()
    {
      ...
      BigInteger _8_ref__old;
      _8_ref__old = this.reference;
...
namespace User {
  ...
  public partial class Customer {
    ...
    public void __ctor(Dafny.ISequence<Dafny.Rune> aName, BigInteger anAge, Dafny.ISequence<Dafny.Rune> anAccountNumber, Dafny.ISequence<Dafny.Rune> aSortCode, Dafny.BigRational aMonthlyIncome, Dafny.BigRational aMonthlyOutgoing)
    {
      ...
      if (((this).referenceGenerator) == (object) ((User.Reference)null)) {
        ...
        BigInteger _out3;
        _out3 = ((this).referenceGenerator).getReferenceNumber();
        (this).customerReference = _out3;
      }
    }
  ...
  public partial class Reference {
    ...
    {
      BigInteger @ref = BigInteger.Zero;
      BigInteger _9_ref__old;
      _9_ref__old = this.reference;
      (this).reference = (this.reference) + (BigInteger.One);
      @ref = _9_ref__old;
      return @ref;
    }
...
namespace BankSystem {
  ...
  public partial class Bank {
    ...
    {
      (this).logEvent(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("BEGINNING APPLICATION PROCESS"));
      Dafny.BigRational _10_interest;
      _10_interest = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
      if (((new BigInteger(5000)) <= (requiredAmount)) && ((requiredAmount) <= (new BigInteger(7499)))) {
        _10_interest = new Dafny.BigRational(new BigInteger(136), BigInteger.Parse("10"));
      } else if (((new BigInteger(7500)) <= (requiredAmount)) && ((requiredAmount) <= (new BigInteger(10000)))) {
        _10_interest = new Dafny.BigRational(new BigInteger(63), BigInteger.Parse("10"));
      } else {
        throw new System.Exception("unreachable alternative");
      }
      Product.PersonalLoan _11_loan;
      Product.PersonalLoan _nw2 = new Product.PersonalLoan();
      _nw2.__ctor(requiredAmount, repaymentPeriod, _10_interest);
      _11_loan = _nw2;
      if ((_11_loan) == (object) ((Product.PersonalLoan)null)) {
        (this).logEvent(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("ERROR: UNABLE TO CREATE LOAN"));
        return ;
      }
      User.Customer _12_customer;
      bool _13_applicationStatus;
      User.Customer _out4;
      bool _out5;
      (this).registerApplication(name, age, accountNumber, sortCode, monthlyIncome, monthlyOutgoings, _11_loan, out _out4, out _out5);
      _12_customer = _out4;
      _13_applicationStatus = _out5;
      if ((_12_customer) == (object) ((User.Customer)null)) {
        (this).logEvent(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("ERROR: UNABLE TO CREATE CUSTOMER"));
        return ;
      }
      bool _out6;
      _out6 = (this).processApplication(_12_customer, _11_loan);
      _13_applicationStatus = _out6;
      if ((_13_applicationStatus) == (false)) {
        (_11_loan).setStatus(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("rejected"));
      } else if ((_13_applicationStatus) == (true)) {
        (_11_loan).setStatus(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("approved"));
      } else {
        throw new System.Exception("unreachable alternative");
      }
      (this).completeApplication(_12_customer, _11_loan);
      (this).logEvent(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("APPLICATION PROCESS COMPLETE"));
    }
    public void registerApplication(Dafny.ISequence<Dafny.Rune> name, BigInteger age, Dafny.ISequence<Dafny.Rune> accountNumber, Dafny.ISequence<Dafny.Rune> sortCode, Dafny.BigRational monthlyIncome, Dafny.BigRational monthlyOutgoings, Product.PersonalLoan aLoan, out User.Customer aCustomer, out bool isLoanRegistered)
    {
      ...
      bool _14_loanRegistered;
      _14_loanRegistered = false;
      User.Customer _15_customer;
      User.Customer _out7;
      _out7 = (this).registerCustomer(name, age, accountNumber, sortCode, monthlyIncome, monthlyOutgoings);
      _15_customer = _out7;
      if ((_15_customer) == (object) ((User.Customer)null)) {
        User.Customer _rhs4 = _15_customer;
        bool _rhs5 = _14_loanRegistered;
        aCustomer = _rhs4;
      ...
      isLoanRegistered = _out8;
      BigInteger _16_customerRef;
      BigInteger _out9;
      _out9 = (_15_customer).getCustomerReference();
      _16_customerRef = _out9;
      BigInteger _17_loanRef;
      BigInteger _out10;
      _out10 = (aLoan).getLoanReference();
      _17_loanRef = _out10;
      (this).associateCustomerLoan(_17_loanRef, _16_customerRef);
      Dafny.ISequence<Dafny.Rune> _18_message;
      _18_message = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Your application has been recieved and will be processed");
      (this).informCustomer(_15_customer, _18_message);
      (this).logEvent(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("APPLICATION REGISTRATION COMPLETE"));
      User.Customer _rhs6 = _15_customer;
      bool _rhs7 = _14_loanRegistered;
      aCustomer = _rhs6;
    ...
    public User.Customer registerCustomer(Dafny.ISequence<Dafny.Rune> name, BigInteger age, Dafny.ISequence<Dafny.Rune> accountNumber, Dafny.ISequence<Dafny.Rune> sortCode, Dafny.BigRational monthlyIncome, Dafny.BigRational monthlyOutgoings)
    {
      ...
      User.Customer _19_aCustomer;
      User.Customer _nw3 = new User.Customer();
      _nw3.__ctor(name, age, accountNumber, sortCode, monthlyIncome, monthlyOutgoings);
      _19_aCustomer = _nw3;
      if ((_19_aCustomer) == (object) ((User.Customer)null)) {
        newCustomer = _19_aCustomer;
        return newCustomer;
      }
      (this).addCustomer(_19_aCustomer);
    ...
    public bool registerLoan(Product.PersonalLoan aLoan)
    {
      ...
      bool _20_verified;
      _20_verified = false;
      BigInteger _21_loanAmount;
      BigInteger _out11;
      _out11 = (aLoan).getRequiredAmount();
      _21_loanAmount = _out11;
      bool _out12;
      _out12 = (this).verifyCapitalAmount(this.capitalFundValue, (this).capitalFundMinimumThreshold, _21_loanAmount);
      _20_verified = _out12;
      if (_20_verified) {
        bool _out13;
        _out13 = (this).reserveLoanFunds(aLoan);
        _20_verified = _out13;
      }
      if (_20_verified) {
        (this).addLoan(aLoan);
    ...
    public bool processApplication(User.Customer aCustomer, Product.PersonalLoan aLoan)
    {
      ...
      (this).logEvent(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("BEGINNING PROCESSING APPLICATION PROCESS"));
      bool _22_verified;
      _22_verified = false;
      BigInteger _23_customerAge;
      BigInteger _out14;
      _out14 = (aCustomer).getAge();
      _23_customerAge = _out14;
      bool _out15;
      _out15 = (aLoan).verifyAgeCriteria(_23_customerAge);
      _22_verified = _out15;
      if (!(_22_verified)) {
        Dafny.ISequence<Dafny.Rune> _24_message;
        _24_message = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Your application has failed the loan age criteria process");
        (this).informCustomer(aCustomer, _24_message);
        isSuccessful = _22_verified;
        return isSuccessful;
      }
      Dafny.BigRational _25_customerMonthlyIncome;
      Dafny.BigRational _out16;
      _out16 = (aCustomer).getMonthlyIncome();
      _25_customerMonthlyIncome = _out16;
      Dafny.BigRational _26_customerMonthlyOutgoings;
      Dafny.BigRational _out17;
      _out17 = (aCustomer).getMonthlyOutgoings();
      _26_customerMonthlyOutgoings = _out17;
      bool _out18;
      _out18 = (aLoan).verifyIncomeCriteria(_25_customerMonthlyIncome, _26_customerMonthlyOutgoings);
      _22_verified = _out18;
      if (!(_22_verified)) {
        Dafny.ISequence<Dafny.Rune> _27_message;
        _27_message = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Your application has failed the loan income criteria process");
        (this).informCustomer(aCustomer, _27_message);
        isSuccessful = _22_verified;
        return isSuccessful;
      }
      BigInteger _28_customerCreditScore;
      BigInteger _out19;
      _out19 = (this).obtainCustomerCreditScore((this).referenceAgency, aCustomer);
      _28_customerCreditScore = _out19;
      bool _out20;
      _out20 = (aLoan).verifyCreditScore(_28_customerCreditScore);
      _22_verified = _out20;
      if (!(_22_verified)) {
        Dafny.ISequence<Dafny.Rune> _29_message;
        _29_message = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Your application has failed the credit score criteria process");
        (this).informCustomer(aCustomer, _29_message);
        isSuccessful = _22_verified;
        return isSuccessful;
      }
      (this).logEvent(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("PROCESSING APPLICATION PROCESS COMPLETE"));
      isSuccessful = _22_verified;
      return isSuccessful;
    }
    ...
    {
      Dafny.ISequence<Dafny.Rune> _30_customerName;
      Dafny.ISequence<Dafny.Rune> _out21;
      _out21 = (aCustomer).getName();
      _30_customerName = _out21;
      Dafny.ISequence<Dafny.Rune> _31_customerMessage;
      _31_customerMessage = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Customer Message: "), _30_customerName), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" :: ")), message);
      Dafny.Helpers.Print((_31_customerMessage).ToVerbatimString(false));
    ...
    public BigInteger obtainCustomerCreditScore(Support.CreditReferenceAgency referenceAgency, User.Customer aCustomer)
    {
      ...
      Dafny.ISequence<Dafny.Rune> _32_customerName;
      Dafny.ISequence<Dafny.Rune> _out22;
      _out22 = (aCustomer).getName();
      _32_customerName = _out22;
      BigInteger _33_aScore;
      BigInteger _out23;
      _out23 = (referenceAgency).getCreditScore(_32_customerName);
      _33_aScore = _out23;
    ...
    {
      bool success = false;
      BigInteger _34_loanAmount;
      BigInteger _out24;
      _out24 = (theLoan).getRequiredAmount();
      _34_loanAmount = _out24;
      BigInteger _35_startingCapitalfund;
      _35_startingCapitalfund = this.capitalFundValue;
      BigInteger _36_startingReserveFund;
      _36_startingReserveFund = this.reservedFunds;
      (this).capitalFundValue = (this.capitalFundValue) - (_34_loanAmount);
      (this).reservedFunds = (this.reservedFunds) + (_34_loanAmount);
      BigInteger _37_finishingCapitalFund;
      _37_finishingCapitalFund = this.capitalFundValue;
      BigInteger _38_finishingReservedFund;
      _38_finishingReservedFund = this.reservedFunds;
      bool _39_both;
      _39_both = ((_37_finishingCapitalFund) == ((_35_startingCapitalfund) - (_34_loanAmount))) && ((_38_finishingReservedFund) == ((_36_startingReserveFund) + (_34_loanAmount)));
    ...
    public void completeApplication(User.Customer theCustomer, Product.PersonalLoan theLoan)
    {
      ...
      Dafny.ISequence<Dafny.Rune> _40_loanStatus;
      Dafny.ISequence<Dafny.Rune> _out25;
      _out25 = (theLoan).getStatus();
      _40_loanStatus = _out25;
      if ((_40_loanStatus).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("rejected"))) {
        Dafny.ISequence<Dafny.Rune> _41_message;
        _41_message = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("We are sorry that your application cannot be processed at this time.");
        bool _42_fundsReleased;
        bool _out26;
        _out26 = (this).releaseLoanFunds(theLoan);
        _42_fundsReleased = _out26;
        if (_42_fundsReleased) {
          Dafny.ISequence<Dafny.Rune> _43_message;
          _43_message = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Loan funds released");
          (this).logEvent(_43_message);
        }
      }
      if ((_40_loanStatus).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("approved"))) {
        bool _44_success;
        bool _out27;
        _out27 = (this).transferLoanToCustomer(theLoan, theCustomer);
        _44_success = _out27;
        Dafny.ISequence<Dafny.Rune> _45_accNo;
        Dafny.ISequence<Dafny.Rune> _46_sortCode;
        Dafny.ISequence<Dafny.Rune> _out28;
        Dafny.ISequence<Dafny.Rune> _out29;
        (theCustomer).getPaymentDetails(out _out28, out _out29);
        _45_accNo = _out28;
        _46_sortCode = _out29;
        Dafny.ISequence<Dafny.Rune> _47_message;
        _47_message = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Your application has been successful. The required loan amount has been transferred to account number: "), _45_accNo), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" sort code: ")), _46_sortCode);
        (this).informCustomer(theCustomer, _47_message);
        (this).logEvent(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("APPLICATION COMPLETION PROCESS COMPLETE"));
      }
    }
    public bool releaseLoanFunds(Product.PersonalLoan theLoan)
    {
      bool success = false;
      BigInteger _48_loanAmount;
      BigInteger _out30;
      _out30 = (theLoan).getRequiredAmount();
      _48_loanAmount = _out30;
      BigInteger _49_startingCapitalfund;
      _49_startingCapitalfund = this.capitalFundValue;
      BigInteger _50_startingReserveFund;
      _50_startingReserveFund = this.reservedFunds;
      (this).capitalFundValue = (this.capitalFundValue) + (_48_loanAmount);
      (this).reservedFunds = (this.reservedFunds) - (_48_loanAmount);
      BigInteger _51_finishingCapitalFund;
      _51_finishingCapitalFund = this.capitalFundValue;
      BigInteger _52_finishingReservedFund;
      _52_finishingReservedFund = this.reservedFunds;
      bool _53_both;
      _53_both = ((_51_finishingCapitalFund) == ((_49_startingCapitalfund) + (_48_loanAmount))) && ((_52_finishingReservedFund) == ((_50_startingReserveFund) - (_48_loanAmount)));
    ...
    {
      bool success = false;
      Dafny.ISequence<Dafny.Rune> _54_accNo;
      Dafny.ISequence<Dafny.Rune> _55_sortCode;
      Dafny.ISequence<Dafny.Rune> _out31;
      Dafny.ISequence<Dafny.Rune> _out32;
      (theCustomer).getPaymentDetails(out _out31, out _out32);
      _54_accNo = _out31;
      _55_sortCode = _out32;
      Dafny.ISequence<Dafny.Rune> _56_message;
      _56_message = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Transfer funds: account number:"), _54_accNo), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" sort code: ")), _55_sortCode);
      BigInteger _57_loanAmount;
      BigInteger _out33;
      _out33 = (theLoan).getRequiredAmount();
      _57_loanAmount = _out33;
      BigInteger _58_startingReserveFund;
      _58_startingReserveFund = this.reservedFunds;
      (this).reservedFunds = (this.reservedFunds) - (_57_loanAmount);
      BigInteger _59_finishingReservedFund;
      _59_finishingReservedFund = this.reservedFunds;
      bool _60_transferred;
      _60_transferred = (_59_finishingReservedFund) == ((_58_startingReserveFund) - (_57_loanAmount));
      (this).logEvent(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LOAN FUNDS TRANSFERRED"));
      success = _60_transferred;
      return success;
    }
    public void logEvent(Dafny.ISequence<Dafny.Rune> eventMessage)
    {
      Dafny.ISequence<Dafny.Rune> _61_message;
      _61_message = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("System Log: Event :: "), eventMessage);
      Dafny.Helpers.Print((_61_message).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
